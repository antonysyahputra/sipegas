...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <script
      ...
      defer
    ></script>
    <script src="{{ asset('js/theme/init-alpine.js') }}"></script>
  </head>
  <body>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              @if (session('status'))
            <div class="bg-red-500 p-2 rounded-md mb-6 text-white text-center">
                {{ session('status') }}
            </div>
            @endif
              ...
              @error('password')
                ...
                @enderror
                        <input type="checkbox" class="mt-4" name="remember" id="remember">
