...
<div class="container px-6 mx-auto grid">
    ...
    >
      <form action="{{ route('employees.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <label for="gender" class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">
          Jenis Kelamin
          </span>
          <select
            name="gender"
            class="block w-full mt-1 @error('gender') border-red-600 @enderror text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
          >
        ...
        <label for="department_id" class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">
          Department
          </span>
          <select
            name="department_id"
            class="block w-full mt-1 @error('department_id') border-red-600 @enderror text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
          >
            <option value=""></option>
        ...
        <label for="phone_number" class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">No Telepon</span>
          <input
            name="phone_number"
            id="phone_number"
            class="block w-full mt-1 @error('phone_number') border-red-600 @enderror text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            placeholder=""
          />
          @error('phone_number')   
            <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label for="hire_date" class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">Tahun Masuk</span>
          <input
            name="hire_date"
            id="hire_date"
            type="date"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('hire_date') border-red-600 @enderror"
            placeholder=""
          />
          @error('hire_date')   
            <span class="text-xs text-red-600 dark:text-red-400">
