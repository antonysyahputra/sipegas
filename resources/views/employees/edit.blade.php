...
<div class="container px-6 mx-auto grid">
    ...
    <form action="{{ route('employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
      ...
      <label for="phone_number" class="block text-sm">
        <span class="text-gray-700 dark:text-gray-400">No Telepon</span>
        <input
          name="phone_number"
          id="phone_number"
          value="{{ old('email', $employee->phone_number) }}"
          class="block w-full mt-1 @error('phone_number') @enderror text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
          placeholder=""
        />
        @error('phone_number')   
          <span class="text-xs text-red-600 dark:text-red-400">
      ...
      <label for="hire_date" class="block text-sm">
      ...
      <input type="text" name="old_image" value="{{ $employee->image }}">
      ...
      <div class="text-left py-3 px-4">
        <img
        class="object-cover w-1/12"
